...
$checks = [
    ...
    'Has boot.js' => strpos($html, 'boot.js') !== false,
    ...
    'Has cache-busted script URL map' => strpos($html, 'v2ScriptUrls') !== false,
    'Has module bootstrap entry' => strpos($html, 'data-v2-entry="module-boot"') !== false && strpos($html, 'type="module"') !== false,
