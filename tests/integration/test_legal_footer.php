...
$checks = [
    ...
    'Privacy route key rendered' => strpos($footerHtml, 'data-legal-key="privacy"') !== false,
    ...
    'Delegated route handler exists in JS' => strpos($canvasJs, 'handleLegalRouteClick(event, trigger.dataset.legalKey') !== false,
